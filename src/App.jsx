...
return (
  ...
  <div className="rendered" style={sty}>{search2===''?<><div style={{textAlign:'center'}}><h1 style={{color:'white',fontFamily: 'Lato'}}>ENTER CHANNEL NAME <LockOpenIcon style={{marginTop:-10}}/> </h1><img style={{borderRadius:10,height:"59vh",width:"90vw"}} src="https://media4.giphy.com/media/Mb9dQnfZXSBYMhU2Nv/giphy.gif" /></div></>:JSON.parse(allData).map(zcard)}</div>
    </>
