...
type="text/html">
    Alternative Content
        ...
        <a href={props.qua?props.link+props.qua:props.link} target="_parent" rel="noreferrer" className="" style={{padding:30,textDecoration:'none',}}> <img src={props.imgsrc} style={{borderRadius:999999}} className="card-img-top" alt="SABRR KRO"  /></a>
